-- Corrige a ambiguidade de created_at no retorno da baixa administrativa atomica.
...
begin
  ...
  insert into public.historico as h (
    produto_id,
    quantidade_anterior,
    quantidade_nova,
    usuario,
  ...
  returning h.id, h.created_at into v_historico_id, v_historico_created_at;
