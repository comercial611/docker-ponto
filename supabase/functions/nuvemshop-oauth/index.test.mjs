...
assert.match(callbackSource, /buildCleanOAuthResultUrl\(requiredEnv\("SUPABASE_URL"\)\)/);
assert.doesNotMatch(callbackSource, /new URL\(request\.url\)[\s\S]{0,300}Location/);
